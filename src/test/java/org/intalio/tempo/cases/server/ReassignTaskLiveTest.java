...
public class ReassignTaskLiveTest extends TestCase {
    ...
    private ACMRequestProcessor requestProcessor;
    private IACMServer tmsServer;
    ...
    public void testReassginLive() throws Exception {
    	...
    	ICaseDAOConnectionFactory daoFactory=new SimpleTaskDAOConnectionFactory();
    	ICaseDAOConnection dao=daoFactory.openConnection();
    	/*
         * Get available users
         */
    ...
    void initTMSRequestProcessor() throws Exception {
        requestProcessor = new ACMRequestProcessor(new SimpleTaskDAOConnectionFactory());
