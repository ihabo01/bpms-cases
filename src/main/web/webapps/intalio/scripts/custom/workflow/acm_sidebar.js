...
"getCaseTypeListRequest":{"@xmlns":acmNS,"participantToken":{"$":participantToken}}};
	 ...
	 var response=$.ajax({ 
		...
		submenu+='<li  id="moduleID'+caseType.ID+'"><a href="#cases.htm?type='+caseType.ID+'" onclick="javascript:selectMenuAndChangepage(this,\'cases\',\'cases.htm\');"> <i class="menu-icon fa fa-caret-right"></i>'+caseType.description+'</a></li>';
		}
